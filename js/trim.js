...
{	
    ...
    if($('#id_table_trim').length)
    {
            ...
            [
                ...
                {   
                    ...
                    render: function(data,type)
                    {
                        ...
                        {
                            data_opciones = '<center><button type="button" data-bs-toggle="modal" data-bs-target="#modal_trim_update" class="btn btn-icon btn-primary btn-sm"><i class="fe fe-edit"></i></button>&nbsp;<button type="button" id="delete_trim" class="btn btn-icon btn-danger btn-sm" title="Delete this Trim"><i class="fa fa-trash"></i></button></center>'
                        }
        ...
        $('#id_table_trim tbody').on( 'click', 'button#delete_trim', function ()
        {
            ...
            swal({
                title: "Delete Trim?",
                text: "Are you sure to delete this Trim?",
                type: "warning",
                showCancelButton: true,
                    ...
                    ({ 
                        ...
                        success: function (data, status, jqXHR) 
                        {
                            ...
                            else
                            {
                                swal({
                                    title: "Warning",
                                    text: "This Trim is not available to delete",
                                    type: "warning",
                                    showCancelButton: false,
                                    confirmButtonClass: "btn-success",
