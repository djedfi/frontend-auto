            ...
            <div class="container-login100">
                <div id="id_div_login" class="wrap-login100 p-6 d-block">
                    <form class="login100-form validate-form" id="id_form_reset">
                        ...
                        <input type="hidden" name="hid_tipo_token_rst" id="id_hid_tipo_token_rst" value="10"> 
                            ...
                            <div class="tab-menu-heading">
                                <div class="tabs-menu1">
                                    ...
                                    <ul class="nav panel-tabs">
                                        <li class="mx-0"><a href="#tab5" class="active" data-bs-toggle="tab">New Password</a></li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab5">
                                        ...
                                        <div class="text-end pt-4">
                                            <p class="mb-0"><a href="./?mod=login" class="text-primary ms-1">Login?</a></p>
                                        </div>
