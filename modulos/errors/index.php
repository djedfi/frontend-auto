<div class="login-img">
    ...
    <div id="global-loader">
        <?php 
            echo '<img src="'.URL_AA_RIMG.'loader.svg" class="loader-img" alt="Loader">';
        ?>
    </div>
    <!-- End GLOBAL-LOADER -->
            ...
            <div class="container text-center">
                <div class="error-template">
                    ...
                    <div class="text-center">
                        <a class="btn btn-secondary mt-5 mb-5" href="./?mod=login"> <i class="fa fa-long-arrow-left"></i> Back to Home </a>
                    </div>
                </div>
            </div>
        </div>
